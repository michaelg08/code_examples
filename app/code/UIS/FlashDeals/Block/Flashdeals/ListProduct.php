...
class ListProduct extends AbstractProduct implements IdentityInterface
{
    ...
    protected function _getProductCollection()
    {
        ...
        $flashdealProductIds = $this->uisHelper->getFlashdealProductIds();
        $ids = [];
        foreach ($flashdealProductIds as  $flashdealProductId) {
            $ids[] = (int)$flashdealProductId['flashdeal_product_ids'];
        }
        $this->_productCollection->addAttributeToFilter('entity_id', ['in', $ids])
    ...
    /**
     * Returns full Product object by collection item id   
     */
    public function getFullProduct($collectionItem) {
        return $this->product->load($collectionItem->getEntityId());
    }
     ...
     */
    public function getFlashdealProductData($id)
    {
        return $this->uisHelper->getFlashdealProductDataById($id);
    } 
