...
namespace UIS\FlashDeals\Model\FlashdealProducts;

use Magento\Framework\App\Request\DataPersistorInterface;
use UIS\FlashDeals\Model\ResourceModel\FlashdealProducts\CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('uis_flashdeals_flashdeals_product');

        if (!empty($data)) {
            $model = $this->collection->getNewEmptyItem();
            $model->setData($data);
            $this->loadedData[$model->getId()] = $model->getData();
            $this->dataPersistor->clear('uis_flashdeals_flashdeals_product');
        }
